...
using OrderData = Business.Experts.OrderExpert.Common.Infrastructure.Data.Models.Order;
using OrderDomain = Business.Experts.OrderExpert.Common.Business.Domain.Order;

namespace Business.Experts.OrderExpert.PlaceOrder;
