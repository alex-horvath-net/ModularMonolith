namespace Business.Modules.OrderExpert.Common.Business.Domain;
...
public sealed class Order {
    ...
    public Business.Modules.OrderExpert.Common.Infrastructure.Data.Models.Order ToDataModel() => new() {
        Id = Id,
        CustomerId = CustomerId,
    ...
    private Business.Modules.OrderExpert.Common.Infrastructure.Data.Models.OrderLine ToInfraOrderLine(OrderLine domainOrderLine) => new() {
